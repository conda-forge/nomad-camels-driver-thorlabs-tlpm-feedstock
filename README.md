About nomad-camels-driver-thorlabs-tlpm-feedstock
=================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/nomad-camels-driver-thorlabs-tlpm-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/nomad-camels-driver-thorlabs-tlpm-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add nomad-camels-driver-thorlabs-tlpm
# for installing globally
pixi global install nomad-camels-driver-thorlabs-tlpm
```
...
It is possible to list all of the versions of `nomad-camels-driver-thorlabs-tlpm` available on your platform:
...
```
pixi search nomad-camels-driver-thorlabs-tlpm --channel conda-forge
```
